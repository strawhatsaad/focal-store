...
import { BookOpen, Sparkles, ArrowRight } from "lucide-react"; // Changed Sun to BookOpen

const LearningCenterComingSoonPage = () => {
  return (
    <main className="min-h-[calc(100vh-150px)] flex flex-col items-center justify-center bg-gradient-to-br from-slate-50 to-gray-100 text-center p-6 sm:p-8">
      <div className="max-w-md">
        <div className="mb-8 flex justify-center">
          <div className="p-4 bg-green-500 rounded-full shadow-lg animate-pulse">
            {" "}
            {/* Changed color */}
        ...
        <p className="mt-4 text-lg sm:text-xl text-gray-600">
          Our Learning Center is under construction. We&apos;re gathering the
          best resources to help you understand all things vision care.
        </p>
        ...
        <div className="mt-10 flex justify-center items-center space-x-2 text-gray-400">
          ...
          <span className="text-xs">
            Insightful articles and guides coming soon.
          </span>
          <Sparkles size={16} />
        </div>
      </div>
...
export default LearningCenterComingSoonPage;
