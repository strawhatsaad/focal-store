...
export const Hero = () => {
  ...
  return (
    <section
      id="hero"
      ref={heroRef}
      className="pt-8 pb-20 md:pt-5 md:pb-10 lg:pb-7 bg-[#F7F4EE] overflow-x-clip lg:-mt-28"
    >
      <div className="container">
        <div className="md:flex items-center">
          <div className="md:w-[520px] lg:mt-32">
            ...
            <div className="lg:mt-6 flex flex-col gap-2">
              <p className="text-[22px] text-black font-medium tracking-tight mt-6">
          ...
          <div className="mt-20 md:mt-0 md:h-[648px] md:flex-1 relative">
            <motion.img
              src={heroImage.src}
              alt="Hero Image"
              className="md:absolute md:h-full md:w-auto md:max-w-none md:-left-6 lg:-left-28 lg:h-[460px] lg:mt-40"
              animate={{
                translateY: [-10, 10],
              }}
              transition={{
