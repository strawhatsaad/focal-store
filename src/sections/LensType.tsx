    ...
    <section className="mt-16">
      <div className="container">
        <div className="flex flex-col items-center md:gap-y-2 lg:gap-y-4">
          <h2 className="font-black md:text-4xl lg:text-7xl tracking-tighter text-center bg-gradient-to-b from-black to-[#001E80] text-transparent bg-clip-text">
            Lens Type
          </h2>
          <p className="md:text-lg lg:text-xl font-medium text-center md:tracking-tighter lg:tracking-normal">
            Match your high-end frame with the perfect lens
          </p>
        </div>
        <div className="md:mt-14 lg:mt-20">
          <div className="mx-auto flex flex-col justify-center items-center md:gap-4 lg:gap-10">
            <div className="grid grid-cols-3 md:gap-6 lg:gap-10 md:w-[750px] lg:w-[1200px] md:min-h-[350px] lg:min-h-[450px]">
              <div
            ...
            <div className="grid grid-cols-4 gap-10 md:w-[750px] lg:w-[1200px] md:min-h-[225px] lg:min-h-[325px]">
              <div
